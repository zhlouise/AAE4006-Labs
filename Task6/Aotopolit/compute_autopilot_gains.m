...
UAV.delta_t_max = 1; % can be regarded as a normalized parameter
UAV.delta_t_min = 0;
...
% altitude
UAV.W_h = 16; %bandwidth separation pitch and altitude
...
% airspeed with Pitch
UAV.W_V2 = 16; % bandwidth separation
...
UAV.kp_V = (-UAV.a_V1+2*UAV.zeta_V*UAV.omega_n_V)/(UAV.a_V2);